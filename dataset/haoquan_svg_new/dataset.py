...
class NewHQSVGDatasetSFT:
    ...
    def load_dataset(
        ...
        **kwargs
        ...
        # Filter training data
        filtered_train = NewHQSVGDatasetSFT._filter_data(
            train_data,
            filter_successful_only,
            filter_has_description,
            filter_has_svg,
        ...
        # Filter test data
        filtered_test = NewHQSVGDatasetSFT._filter_data(
            test_data,
            filter_successful_only,
            filter_has_description,
            filter_has_svg,
        ...
        # Process examples
        process_with_instruction = lambda example: NewHQSVGDatasetSFT.process_example(
            example, instruction_prompt=instruction_prompt
        )
        train_dataset = train_dataset.map(process_with_instruction)
        test_dataset = test_dataset.map(process_with_instruction)
