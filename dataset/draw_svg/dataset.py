...
class DrawSVGDataset:
    ...
    def load_dataset(
        ...
        **kwargs
        ...
        dataset = dataset.map(DrawSVGDataset.process_example)
        # for split in dataset:
    ...
    def process_example(example: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "prompt": [
                ...
                {"role": "user", "content": f"Please write SVG code for generating the image corresponding to the following description: {example['text']}"},
            ],
